...
if __name__ == "__main__":
    ...
    parser.add_argument("--robot", type=str, default="go2", choices=["go2", "spot_real", "hyqreal2", "spot_arm_real"])
    ...
    if robot_prefix == 'go2':
        dataset_name = 'go2_sim_n_runs_50_data_freq_100hz'
        dataset_name_short = 'go2_sim_n_runs_50_data_freq_100hz'
        tau_field = 'tau_dyn'

    elif robot_prefix == 'spot_real':
        dataset_name = 'spot_real_freq_100hz'
        dataset_name_short = 'spot_real_freq_100hz'

    elif robot_prefix == 'spot_arm_real':
        dataset_name = 'spot_arm_real_freq_100hz'
        dataset_name_short = 'spot_arm_real_freq_100hz'

    elif robot_prefix == 'hyqreal2':
        dataset_name = 'hyqreal2_real_freq_100hz'
        dataset_name_short = 'hyqreal2_real_freq_100hz'
    ...
    if robot_prefix == 'go2':
        test_labels = ['env_0_run_2', 'env_0_run_10', 'env_0_run_11', 'env_0_run_28', 'env_0_run_41']
    elif robot_prefix == 'spot_real':
        test_labels = ['env_0_run_32', 'env_0_run_52']
    elif robot_prefix == 'spot_arm_real':
        test_labels = ['env_0_run_60', 'env_0_run_71']
    elif robot_prefix == 'hyqreal2':
        test_labels = ['env_0_run_2', 'env_0_run_5', 'env_0_run_25']
